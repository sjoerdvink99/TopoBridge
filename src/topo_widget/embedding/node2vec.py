# Source: https://github.com/benedekrozemberczki/karateclub/blob/master/karateclub/node_embedding/neighbourhood/node2vec.py
from typing import List
import networkx as nx
import numpy as np
from gensim.models.word2vec import Word2Vec
from .estimator import Estimator
from .random_walker import BiasedRandomWalker
...
class Node2Vec(Estimator):
    ...
    def fit(self, graph: nx.classes.graph.Graph):
        ...
        self._embedding = [model.wv[str(n)] for n in graph.nodes()]
